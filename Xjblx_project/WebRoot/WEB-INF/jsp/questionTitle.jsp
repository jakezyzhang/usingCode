...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/setTitle.css"/>
		<script src="${pageContext.request.contextPath }/js/jquery-1.8.3.min.js" type="text/javascript" charset="utf-8"></script>
		<script src="${pageContext.request.contextPath }/js/setTitle.js" type="text/javascript" charset="utf-8"></script>
			...
			<div id="main">
				<div id="surveyTitle">
					<div id="surveyHead">
						...
						<input type="text" name="questionnair_name" id="title" value="">${requestScope.questionnairnameMistake }
					</div>
				</div>
				<div id="button">
