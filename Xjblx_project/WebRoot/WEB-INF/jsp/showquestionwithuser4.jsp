			...
			<c:forEach items="${questionnaireByUserList }" var="list">
				<table>
			 		...
			 		<tr>
			 			...
			 			<td><a href="${pageContext.request.contextPath }/countEachNum.action?questionnairName=${list.questionnairName}">发布问卷</a></td>
			 			<td><a href="${pageContext.request.contextPath }/showQuestionDetails.action?questionnairName=${list.questionnairName}">统计问卷</a></td>
			 		</tr>
