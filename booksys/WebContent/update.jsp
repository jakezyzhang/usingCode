...
<body>
	<form action="book" method="post">
		<table width="80%" align="center">
			...
			<tr>
				<td>书名：<input type="hidden" name="op" value="update" />
						<input type="hidden" name="id" value="${book.id }" />	
				</td>
				<td><input type="text" name="name" value="${book.name }"></input></td>
			</tr> 
			<tr>
				<td>分类：</td>
				<td>
			...
			<tr>
				<td>价格：</td>
				<td><input type="text" name="price"  value="${book.price }"></input></td>
			</tr>
			<tr>
				<td>作者：</td>
				<td><input type="text" name="author"  value="${book.author }"></input></td>
			</tr>
			<tr>
