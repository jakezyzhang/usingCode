...
%> 
 ...
 <div id="header">
			...
			<form action="loginCL.jsp" method="post">
				<table style="position: absolute;left: 600px;top:10px">
					<tr>
						<td style="color:white;">用户名</td>
						<td><input type="text" name="username" ></input></td>
						<td style="color:white;">密码</td>
						<td><input type="password" name="password" ></input></td>
						<td><input type="submit" value="登陆" style="font-size:10px;"></input></td>
						<td><font  style="  color: #FFFFFF; text-decoration:none;font-size:15px;">|</font><td>
						<td><input type="button" value="注册" style="font-size:10px;" onclick="javascrtpt:window.location.href='agreement.html'"></input></td>
					</tr>
					<tr><span style="color: red;position: absolute;left: 600px;top: 40px"><%=message != null && !message.equals("")?message:"" %></span></tr>
			</table>
			</form>
			<div id="banner">
				Web开发工具介绍
