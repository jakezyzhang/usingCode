	...
	%>
 	<form action="loginCL.jsp"method="post">
 		<table border="0px" align="center">
 				...
 				<tr height="30px">
 					<td>用户名：</td>
 					<td><input type="text" name="username" value="<%=""+(nameCk!=null? nameCk.getValue():"")+"" %>"/><span style="color: red;position: absolute;left: 830px"><%=message != null && !message.equals("")?message:"" %></span></td>
 				</tr>
 				<tr height="30px">
 					<td>密&nbsp;&nbsp;&nbsp;码：</td>
