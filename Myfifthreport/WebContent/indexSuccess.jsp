...
<%@page import="com.zzy.register.entity.User"%>
<%@page import="com.zzy.register.dao.impl.UserDaoImpl"%>
...
<html>
 ...
 <div id="header">
			...
			<font  style="  color: #FFFFFF; text-decoration:none;font-size:15px;position: absolute;left: 920px">欢迎：${sessionScope.displayName}</font>
			<font  style="  color: #FFFFFF; text-decoration:none;font-size:15px;position: absolute;left: 1060px">|</font>
			<a href="index.jsp" style="  color: #FFFFFF; text-decoration:none;font-size:15px;position: absolute;left: 1070px">退出</a>
			<a href="collect" style="  color: #FFFFFF; text-decoration:none;font-size:15px;position: absolute;left: 1150px">新建</a>
			<div id="banner">
				Web开发工具介绍
			</div>
			 <div id="div1">
